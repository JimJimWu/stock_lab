...
# ==========================================================================
    # 💥 【V2.4 升級：雙軌分流 + 邏輯路由 (Prompt Routing)】
    # 完美落實 MECE 分類原則，引導 AI 將宏觀與細節精準分流
    # ==========================================================================
    summary = f"""請以頂尖量化分析顧問的身份，精準提煉「{company_name}」的產業百科。
    【各欄位獨立判定與精準分流鐵律】（若查無合規資料，請於該欄位填入【資料不足，無法確認】。請落實資訊分流，確保各欄位專注其核心定義）
    1. 主要業務【具體事實】：請具體列出確切已知的現行產品與業務。
    2. 市場規模【量化數據】：請專注提供「具體產值數字」與「機構來源(如 TrendForce)」。請將所有無量化數據的產業宏觀介紹，全數引導至第5點「驅動因子」中呈現。
    3. 價值鏈【具體事實】：請明確指出該公司在上、中、下游的具體定位與代表廠商。
    4. 競爭對手【具體事實】：請精準列出具備實質競爭關係的國內外上市櫃公司確切名稱。
    5. 驅動因子【宏觀趨勢】：請詳盡陳述基於法說會或機構共識的未來成長趨勢、關鍵技術，以及整體的產業宏觀環境背景。
    """
