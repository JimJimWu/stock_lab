...
# ==========================================================================
    # 💥 【V2.5 終極版：雙軌分流 + 範例格式鎖 (Few-Shot)】
    # 直接給定輸出模板，用物理格式徹底封殺 AI 的「說故事本能」
    # ==========================================================================
    summary = f"""請以頂尖量化分析顧問的身份，精準提煉「{company_name}」的產業百科。
    【強制輸出格式與分流鐵律】（嚴禁輸出與規定格式不符的內容。若查無數據，該欄位只能填寫「【資料不足，無法確認】」）
    1. 主要業務：請具體列出確切已知的現行產品與業務。
    2. 市場規模：【嚴格限制格式】只能輸出「產值數字 + 研調機構名稱」。例如格式必須為：「根據 [機構名稱] 預估，[年份]全球[產業名稱]市場規模將達 [具體數字]」。(嚴禁在此填寫公司創立歷史、無數字之簡介！請將宏觀敘述全數移至第5點)
    3. 價值鏈：請明確指出該公司在上、中、下游的具體定位與代表廠商。
    4. 競爭對手：請精準列出具備實質競爭關係的國內外上市櫃公司確切名稱。
    5. 驅動因子：請詳盡陳述未來成長趨勢、關鍵技術與宏觀環境背景。(所有無具體數字的產業介紹請移至此處)
    """
