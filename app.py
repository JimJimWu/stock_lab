...
DEFAULT_STOCKS = {
    ...
    "8299": "群聯",    
    "6147": "頎邦",    
    "3711": "日月光投控", # 新增：先進封裝龍頭
    "2449": "京元電子",   # 新增：AI 晶片高階測試
    "6770": "力積電",
    "6510": "精測",
    "6849": "奇鼎",
    "5297": "廣化",
    ...
    # === AI 伺服器、散熱與電源 (大型權值區) ===
    "2317": "鴻海",    
    "2382": "廣達",      # 新增：AI 伺服器代工龍頭
    "3231": "緯創",      # 新增：AI 伺服器指標股
    "2376": "技嘉",      # 新增：AI 伺服器與主機板
    "2308": "台達電",  
    "3017": "奇鋐",      # 新增：AI 散熱股王
    "3324": "雙鴻",      # 新增：水冷散熱指標
    "2377": "微星",    
...
with st.sidebar:
    ...
    target_sid = st.sidebar.selectbox(
        ...
        index=current_idx,
        format_func=lambda sid: current_stocks.get(sid, sid) if str(sid) in str(current_stocks.get(sid, '')) else f"{sid} ({current_stocks.get(sid, sid)})",
